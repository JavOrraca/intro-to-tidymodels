...
# 1. About Me {background-color='{{< brand color mauvemist >}}'}
...
# 2. Data Science Issues {background-color='{{< brand color mauvemist >}}'}
...
# 3. Intro to Tidymodels {background-color='{{< brand color mauvemist >}}'}
...
![Image: © Posit Software, PBC.](images/resampling.svg){height="70%" width="70%" fig-align="center"}
...
# 4. Intro to Positron {background-color='{{< brand color mauvemist >}}'}
...
# 5. Live Demo {background-color='{{< brand color mauvemist >}}'}
