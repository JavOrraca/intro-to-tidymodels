...
## Agenda {background-color='{{< brand color seaglass >}}'}
...
# Intro to Tidymodels {background-color='{{< brand color seaglass >}}'}
...
* In the Titanic dataset that we'll rely on:
...
- The logistic function maps to an S-shaped curve and this shows how the probability of survival changes smoothly from low to high (or vice versa) as age decreases, highlighting a gradual transition rather than a sudden jump between outcomes
